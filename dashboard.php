...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Members Managment System</a>
            <!-- Sidebar Toggle-->
            ...
            <!-- Navbar-->
            <ul class="navbar-nav" style="margin-right: 35px;">
                        <li style="background:white;"><a class="dropdown-item" href="adminlogout.php">Logout</a></li>
            </ul>
        </nav>
        <div id="layoutSidenav">
           ...
           <div class="container" style="width:700px;">  
                ...
                <div class="table-responsive">  
                     <div align="right">  
                          <button type="button" name="add" id="add" data-bs-toggle="modal" data-bs-target="#add_data_Modal" class="btn btn-warning">Add Members</button>  
                     </div>  
</br>
                     <div id="employee_table">  
                          <table class="table table-bordered">  
                               ...
                               <tr>  
                                    ...
                                    <!-- <td><input type="button" name="delete" value="delete" id="<?php echo $row["id"]; ?>" class="btn btn-danger btn-xs danger_data" /></td>   -->
                                    <td><a style=" color: white;text-decoration: none;"   class="btn btn-danger" href="delete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
                               </tr>  
                               <?php  
                               }  
                               ?>  
